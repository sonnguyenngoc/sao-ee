class Admin::ArticlesController < ApplicationController
  ...
  private
    ...
    def article_params
      params.require(:article).permit(:image_url, :title, :content, :tags, :article_category_id, :code, :location, :title_vi, :content_vi, :image_url_vi, article_list_images_attributes: [:id, :title, :title_vi, :image_url, :article_id, :_destroy])
    end
end
