...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { address: @manufacturer.address, description: @manufacturer.description, image_url: @manufacturer.image_url, name: @manufacturer.name }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { address: @manufacturer.address, description: @manufacturer.description, image_url: @manufacturer.image_url, name: @manufacturer.name }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
